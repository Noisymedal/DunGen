...
def generateBoard():
    ...
    output+="\n\t\t\"Hands\": false,"
    output+="\n\t\t\"CustomImage\": {"
    output+="\n\t\t\t\"ImageURL\": \"file:///C:\\\\Users\\\\BrownIan\\\\OneDrive - University of Wisconsin-Stout\\\\Documents\\\\GitHub\\\\DunGen\\\\static\\\\dungeon.png\","
    output+="\n\t\t\t\"ImageSecondaryURL\": \"file:///C:\\\\Users\\\\BrownIan\\\\OneDrive - University of Wisconsin-Stout\\\\Documents\\\\GitHub\\\\DunGen\\\\static\\\\dungeon.png\","
    output+="\n\t\t\t\"ImageScalar\": 1.0,"
    output+="\n\t\t\t\"WidthScale\": 0.0,"
    output+="\n\t\t\t\"CustomTile\": {"
    output+="\n\t\t\t\t\"Type\": 0,"
